...
import com.itbank.springProject.db.TagDTO;

public class VisionMethod_ {
...
//		}
	...
	public String name() {
		...
		public ArrayList<TagDTO> imgTag() throws Exception {
			...
			for(int i = 0; i < imgs.length; i++){
				...
				System.out.println(i + "번째 사진 판독 중..");
				String tags = "";
				String img = "resources/img/sample/" + imgs[i];
...
//				System.out.println(tx2.translate(detectLandmarks(img)) + " : " + tx2.translate(tags));
				tagList.add(new TagDTO(
						tx2.translate(detectLandmarks(path + img)),
						tx2.translate(tags),
						img
						));
